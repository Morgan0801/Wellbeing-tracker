...
-- ÉTAPE 2: Synchroniser auth.users vers public.users + Créer tags
DO $$
DECLARE
  auth_user RECORD;
  ...
  tag_count INTEGER;
BEGIN
  RAISE NOTICE '✅ Début de la synchronisation...';
  ...
  RAISE NOTICE '✅ Création des tags par défaut...';
  ...
  FOR user_record IN SELECT id FROM public.users LOOP
    ...
    IF tag_count = 0 THEN
      ...
      RAISE NOTICE '✅ 6 tags créés pour utilisateur %', user_record.id;
    ELSE
